...
use clap::Parser;
use turnip_gfx_disasm::abstract_machine::scalar::{BasicScalarValueRefFilter, ScalarValueRef};
...
fn main() {
    ...
    let mut resolver = WorldState::new(BasicScalarValueRefFilter::new());
    for a in actions {
