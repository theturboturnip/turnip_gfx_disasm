//! Rust port of Appendix B of the AMDIL specificiation v2
...
pub enum IL_Shader_Type {
    IL_SHADER_VERTEX = 0, // This code describes a pixel shader
...
// comments in this enum will be added to the il spec
#[derive(Debug, Clone, Copy, PartialEq, Eq, FromPrimitive)]
pub enum IL_Language_Type {
    IL_LANG_GENERIC = 0, // allows for language specific overrides
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, FromPrimitive)]
pub enum ILRegType {
    IL_REGTYPE_CONST_BOOL = 0, // single bit boolean constant
    ...
    IL_REGTYPE_LAST, // Must be < 64, we only have 6 bits for encoding the reg type // SoftIL requires IL_REGTYPE_LAST <= 63
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, FromPrimitive)]
pub enum ILModDstComponent {
    IL_MODCOMP_NOWRITE = 0, // do not write this component
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, FromPrimitive)]
pub enum ILComponentSelect {
    IL_COMPSEL_X_R = 0, //select the 1st component (x/red) for the channel.
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, FromPrimitive)]
pub enum IL_OUTPUT_TOPOLOGY {
    IL_OUTPUT_TOPOLOGY_POINT_LIST = 0,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, FromPrimitive)]
pub enum IL_LOAD_STORE_DATA_SIZE {
...
// type of firstbit
#[derive(Debug, Clone, Copy, PartialEq, Eq, FromPrimitive)]
pub enum IL_FIRSTBIT_TYPE {
    IL_FIRSTBIT_TYPE_LOW_UINT = 0,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, FromPrimitive)]
pub enum ILTsPartition {
    IL_TS_PARTITION_INTEGER = 0,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, FromPrimitive)]
pub enum ILTsOutputPrimitive {
    IL_TS_OUTPUT_POINT = 0,
    IL_TS_OUTPUT_LINE,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, FromPrimitive)]
pub enum IL_DERIV_GRANULARITY {
    IL_DERIVE_COARSE = 0,
    IL_DERIVE_FINE = 0x80,
}
#[derive(Debug, Clone, Copy, PartialEq, Eq, FromPrimitive)]
pub enum IL_IEEE_CONTROL {
    IL_IEEE_IGNORE = 0,
    IL_IEEE_PRECISE = 0x1,
}
#[derive(Debug, Clone, Copy, PartialEq, Eq, FromPrimitive)]
pub enum IL_UAV_READ_TYPE {
    IL_UAV_SC_DECIDE = 0,
